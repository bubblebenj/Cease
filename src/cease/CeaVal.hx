...
class CeaVal {
	...
	// Getter / Setter
	private function getX():X_predef {
		return x;
	}

	private function setX(_value:X_predef):X_predef {
		x = _value;
		return x;
	}

	private function getY():Y_predef {
		return y;
	}

	private function setY(_value:Y_predef):Y_predef {
		y = _value;
		return y;
	}
